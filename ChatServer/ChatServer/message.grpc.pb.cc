...
static const char* ChatService_method_names[] = {
  ...
  "/message.ChatService/SearchFriend",
  "/message.ChatService/GetFriendRequests",
  "/message.ChatService/GetMyFriends",
};
...
ChatService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_SearchFriend_(ChatService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetFriendRequests_(ChatService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetMyFriends_(ChatService_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ChatService::Stub::SearchFriend(::grpc::ClientContext* context, const ::message::SearchFriendReq& request, ::message::SearchFriendRsp* response) {
  return ::grpc::internal::BlockingUnaryCall< ::message::SearchFriendReq, ::message::SearchFriendRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_SearchFriend_, context, request, response);
}

void ChatService::Stub::async::SearchFriend(::grpc::ClientContext* context, const ::message::SearchFriendReq* request, ::message::SearchFriendRsp* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::message::SearchFriendReq, ::message::SearchFriendRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SearchFriend_, context, request, response, std::move(f));
}

void ChatService::Stub::async::SearchFriend(::grpc::ClientContext* context, const ::message::SearchFriendReq* request, ::message::SearchFriendRsp* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_SearchFriend_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::message::SearchFriendRsp>* ChatService::Stub::PrepareAsyncSearchFriendRaw(::grpc::ClientContext* context, const ::message::SearchFriendReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::message::SearchFriendRsp, ::message::SearchFriendReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_SearchFriend_, context, request);
}

::grpc::ClientAsyncResponseReader< ::message::SearchFriendRsp>* ChatService::Stub::AsyncSearchFriendRaw(::grpc::ClientContext* context, const ::message::SearchFriendReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncSearchFriendRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status ChatService::Stub::GetFriendRequests(::grpc::ClientContext* context, const ::message::GetFriendRequestsReq& request, ::message::GetFriendRequestsRsp* response) {
  return ::grpc::internal::BlockingUnaryCall< ::message::GetFriendRequestsReq, ::message::GetFriendRequestsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetFriendRequests_, context, request, response);
}

void ChatService::Stub::async::GetFriendRequests(::grpc::ClientContext* context, const ::message::GetFriendRequestsReq* request, ::message::GetFriendRequestsRsp* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::message::GetFriendRequestsReq, ::message::GetFriendRequestsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetFriendRequests_, context, request, response, std::move(f));
}

void ChatService::Stub::async::GetFriendRequests(::grpc::ClientContext* context, const ::message::GetFriendRequestsReq* request, ::message::GetFriendRequestsRsp* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetFriendRequests_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::message::GetFriendRequestsRsp>* ChatService::Stub::PrepareAsyncGetFriendRequestsRaw(::grpc::ClientContext* context, const ::message::GetFriendRequestsReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::message::GetFriendRequestsRsp, ::message::GetFriendRequestsReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetFriendRequests_, context, request);
}

::grpc::ClientAsyncResponseReader< ::message::GetFriendRequestsRsp>* ChatService::Stub::AsyncGetFriendRequestsRaw(::grpc::ClientContext* context, const ::message::GetFriendRequestsReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetFriendRequestsRaw(context, request, cq);
  result->StartCall();
  return result;
}

::grpc::Status ChatService::Stub::GetMyFriends(::grpc::ClientContext* context, const ::message::GetMyFriendsReq& request, ::message::GetMyFriendsRsp* response) {
  return ::grpc::internal::BlockingUnaryCall< ::message::GetMyFriendsReq, ::message::GetMyFriendsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetMyFriends_, context, request, response);
}

void ChatService::Stub::async::GetMyFriends(::grpc::ClientContext* context, const ::message::GetMyFriendsReq* request, ::message::GetMyFriendsRsp* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::message::GetMyFriendsReq, ::message::GetMyFriendsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetMyFriends_, context, request, response, std::move(f));
}

void ChatService::Stub::async::GetMyFriends(::grpc::ClientContext* context, const ::message::GetMyFriendsReq* request, ::message::GetMyFriendsRsp* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetMyFriends_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::message::GetMyFriendsRsp>* ChatService::Stub::PrepareAsyncGetMyFriendsRaw(::grpc::ClientContext* context, const ::message::GetMyFriendsReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::message::GetMyFriendsRsp, ::message::GetMyFriendsReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetMyFriends_, context, request);
}

::grpc::ClientAsyncResponseReader< ::message::GetMyFriendsRsp>* ChatService::Stub::AsyncGetMyFriendsRaw(::grpc::ClientContext* context, const ::message::GetMyFriendsReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetMyFriendsRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
ChatService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::message::SearchFriendReq, ::message::SearchFriendRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::message::SearchFriendReq* req,
             ::message::SearchFriendRsp* resp) {
               return service->SearchFriend(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ChatService_method_names[6],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::message::GetFriendRequestsReq, ::message::GetFriendRequestsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::message::GetFriendRequestsReq* req,
             ::message::GetFriendRequestsRsp* resp) {
               return service->GetFriendRequests(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ChatService_method_names[7],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::message::GetMyFriendsReq, ::message::GetMyFriendsRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::message::GetMyFriendsReq* req,
             ::message::GetMyFriendsRsp* resp) {
               return service->GetMyFriends(ctx, req, resp);
             }, this)));
}
...
::grpc::Status ChatService::Service::SearchFriend(::grpc::ServerContext* context, const ::message::SearchFriendReq* request, ::message::SearchFriendRsp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status ChatService::Service::GetFriendRequests(::grpc::ServerContext* context, const ::message::GetFriendRequestsReq* request, ::message::GetFriendRequestsRsp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status ChatService::Service::GetMyFriends(::grpc::ServerContext* context, const ::message::GetMyFriendsReq* request, ::message::GetMyFriendsRsp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
